...
namespace Unity.UIWidgets.material {
    public abstract class InputBorder : ShapeBorder {
      ...
      static readonly InputBorder none = new _NoInputBorder();
    ...
    class UnderlineInputBorder : InputBorder {
      ...
      public override Path getInnerPath(Rect rect) {
          Path path = new Path();
          path.addRect(Rect.fromLTWH(rect.left, rect.top, rect.width, Mathf.Max(0.0f, rect.height - this.borderSide.width)));
        return path;
      }
