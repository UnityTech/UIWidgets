...
If you would like to modify this logic, please set `UIWidgetsGlobalSettings.instance.speedUpFrameRate` and/or `UIWidgetsGlobalSettings.instance.coolDownFrameRate` to your own functions.
